...
sfdx force community create --name "B2BSmConnector" --templatename "B2B Commerce" --urlpathprefix "B2BSmConnector" --description "B2B Commerce (Aura) created by Subscription Management Quickstart"
