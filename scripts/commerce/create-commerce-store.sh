...
sfdx force community create --name "b2bsm" --templatename "B2B Commerce" --urlpathprefix "b2bsm" --description "B2B Commerce (Aura) created by Subscription Management Quickstart"
