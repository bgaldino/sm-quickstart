...
export SMARTBYTES_SM_PRICEBOOK_NAME="SmartBytes Subscription Management Price Book"
export SMARTBYTES_COMMERCE_PRICEBOOK_NAME="SmartBytes B2B Commerce Price Book"
...
# commerce interfaces
export INVENTORY_INTERFACE="B2BDeliverySample_58"
export INVENTORY_EXTERNAL_SERVICE="COMPUTE_INVENTORY_B2BDeliverySample_58"
